...
void aes_keyin_write_buf(uint8_t *buf, uint8_t indirect_address, uint8_t length);
void aes_initvect_write_buf(uint8_t *buf, uint8_t indirect_start_address, uint8_t length);
...
void aes_keyin_write_buf(uint8_t *buf, uint8_t indirect_start_address, uint8_t length)
{
   int8_t index;
